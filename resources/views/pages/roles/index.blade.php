...
@section('subcontent')
    <h2 class="intro-y text-lg font-medium mt-10">Data Roles</h2>
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a class="btn btn-primary shadow-md mr-2" href="{{ route('roles.create') }}">Add New Role</a>
            <div class="hidden md:block mx-auto text-slate-500">Showing 1 to 10 of {{ count($roles) }} entries</div>
                        ...
                        <tr class="intro-x">
                            ...
                            <td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    <a class="flex items-center mr-3" href="{{ route('roles.edit',$role->id) }}">
